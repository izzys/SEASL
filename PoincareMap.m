...
Sim.Con = Sim.Con.Set('Period',1.2,'phi_tau',[0.1 0.25 0.4 0.99],'tau',[2 -3],'phi_reflex',[ NaN    0.5  ]); 
...
Sim.IClimCyc =  [  0.359391210428062  -3.578743845708979 NaN NaN 0.718629453132761]; %short reflex LC
